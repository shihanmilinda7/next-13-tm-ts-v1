...
const WebcamComponent = ({ taskDetails, taskid, pathname, taskphotoid, photodataurl }: { taskDetails: CategoryDetailObj, taskid: number, pathname: string, taskphotoid: number, photodataurl: string }) => {
