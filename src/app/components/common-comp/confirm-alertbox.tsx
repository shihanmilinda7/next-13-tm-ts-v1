...
const ConfirmAlertbox = ({
  ...
  const bgColour =
    buttonColour ||
    "bg-gradient-to-r from-red-500 to-red-600 hover:bg-gradient-to-l hover:from-red-500 hover:to-red-600";
  ...
  return (
    <div>
      <button
        ...
        className={
          "rounded-lg py-3 px-8 text-center text-base font-semibold text-white outline-none " +
          bgColour
        }
      >
        {buttonName}
