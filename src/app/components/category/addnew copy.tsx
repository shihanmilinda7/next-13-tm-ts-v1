...
//     params.selRowData?.categoryname ?? ""
//   );
//   const [categoryValues, setCategoryValues] = useState(
//     params.selRowData?.categoryValues ?? []
//   );
...
//     if (categoryid) {
//       const res_del_cat = await fetch("api/category", {
//         method: "DELETE",
//         headers: { "Content-Type": "application/json" },
...
//               {categoryValues.map(
//                 (categoryValue: CategoryDetailObj, index: number) => (
